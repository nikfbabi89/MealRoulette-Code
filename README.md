...
-Users can use whitelist/blacklist filters to narrow down this selection, by using custom tags such as [quick] or [grill]. <br>
-Meals can also be given a special override such as "freeze" which will always remove the meal from the valid selection<br>
...
Step 3a1) Use Jupyer Notebooks to open file "Driver.ipynb"<br>
Step 3a2) Click "run this cell" (play button) [Note: use Kernal - Restart and Run All Cells if the GUI is closed]<br>
